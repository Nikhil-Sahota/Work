                    ...
                    <div className='border-1 rounded border-slate-400'>
                        ...
                        <div className='bg-gray-50 px-4 py-3 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex gap-9'>
                                <input type="checkbox" />
                                <p className='font-bold text-[#374151] text-[11px]  uppercase'>Title</p>
                            </div>

                            <div className='flex font-bold text-[#374151]  text-[11px] gap-[40px] uppercase'>
                                <p className=''>Image</p>
                                <p>Description</p>
                        ...
                        <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex font-normal items-center  text-[#6b7280] text-[14px] gap-[30px]'>
                               ...
                               <p className='text-[#6b7280] font-normal text-[12px] ml-3'>CEO Of SunPark</p>
                                <p className='ml-[30px]'>1</p>

                                <button className='text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-4  py-1 text-center ml-[40px]'>Active</button>
                                <div className='text-[#ffffff] w-[35px] h-[35px] rounded-full flex justify-center items-center bg-blue-700 ml-[15px] hover:bg-blue-800 text-[20px] font-normal'><HiPencil /></div>
                            </div>
                        ...
                        <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex font-normal items-center  text-[#6b7280] text-[14px] gap-[30px]'>
                                <img src="https://packshifts.in/images/iso.png" className='w-[35px]' alt="" />
                                  <p className='text-[#6b7280] font-normal text-[12px] ml-3'>CEO Of SunPark</p>
                                <p className='pl-[30px]'>1</p>
                                <button className='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-1.5 text-center ml-[30px]'>Deactive</button>
