      ...
      <section className='px-3 py-4' >
        ...
        <div className='border-1 rounded border-slate-400'>
          ...
          <div className='bg-slate-100 flex justify-between p-3 border-b pb-4 border-slate-400' >
            <div className='font-semibold text-[#000000 text-[23px]'>View User</div>
          ...
          <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
            ...
            <div className='flex font-normal items-center  text-[#6b7280] ml-4 text-[14px] gap-[30px]'>
              ...
              <button className='text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-4  py-1 text-center ml-[60px]'>Active</button>
          ...
          <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
            ...
            <div className='flex font-normal items-center  text-[#6b7280] ml-4 text-[14px] gap-[30px]'>
              <p>		xyz@gmail.com</p>
              <p className=''>	9876543210</p>
              <button className='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-1.5 text-center ml-[55px]'>Deactive</button>
