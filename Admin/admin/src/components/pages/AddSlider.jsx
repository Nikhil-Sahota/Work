...
export default function AddSlider() {
    return (
        <>
            ...
            <section className='px-2  py-4 mb-15'>



                <div className='rounded border border-slate-400'>
                    <p className='text-[23px]  py-2 px-3 border-b border-slate-400 font-semibold bg-slate-100'>Add Slider</p>
                    <div className='p-3'>
                        <form>
                            <section className='grid grid-cols-[32%_auto] gap-4'>
                                ...
                                <div>
                                    ...
                                    <p className='font-medium text-gray-900 text-[14px]'>Title</p>
                            ...
                            <button type="submit" className=' mt-8 mb-5 text-white bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-[14px] px-4 py-2'>Add Slider</button>
                        </form>
                    </div>
                </div>
