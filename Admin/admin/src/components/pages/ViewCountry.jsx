                ...
                <section className='px-3 py-4' >
                    ...
                    <div className='border-1 rounded border-slate-400'>
                        ...
                        <div className='bg-slate-100 flex justify-between p-3 border-b pb-4 border-slate-400' >
                            <div className='font-semibold text-[#000000 text-[23px]'>View Country</div>
                        ...
                        <div className='bg-gray-50 px-4 py-3 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex gap-9'>
                                <input type="checkbox" />
                                <p className='font-bold text-[#374151] text-[11px] uppercase'>Country Name</p>
                            </div>

                            <div className='flex font-bold text-[#374151] ml-15 text-[11px] gap-[80px] uppercase'>
                        ...
                        <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex font-normal items-center  text-[#6b7280] ml-4 text-[14px] gap-[30px]'>
                                ...
                                <p className='ml-[95px]'>1</p>
                                <button className='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-1.5 text-center ml-[84px]'>Deactive</button>
