                        ...
                        <form>
                            <section className='grid grid-cols-[32%_auto] gap-4'>
                                ...
                                <div>
                                    ...
                                    <p className='font-medium text-gray-900 mt-5 text-[14px]'>Parent Category Name</p>
                                    ...
                                    <p className='font-medium text-gray-900 mt-5 text-[14px]'>Sub Category Name</p>
                                    <select name="" id="" className='text-[14px] border-1 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2 px-3'>
                                        <option value="">Select Category</option>
                                        <option value="">Men's</option>
                                        <option value="">Women</option>
                                    ...
                                    <p className='font-medium text-gray-900 mt-5 text-[14px]'>Category Name</p>
                            ...
                            <button type="submit" className=' mt-8 mb-5 text-white bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-[14px] px-4 py-2'>Add Sub Category</button>
                        </form>
                    </div>
                </div>
