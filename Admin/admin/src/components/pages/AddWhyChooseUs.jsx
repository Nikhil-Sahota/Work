...
export default function AddWhyChooseUs() {
        ...
        <>
            ...
            <section className='px-2  py-4'>
                ...
                <div className='rounded border border-slate-400'>
                    <p className='text-[23px]  py-2 px-3 border-b border-slate-400 font-semibold bg-slate-100'>Add Why Choose Us</p>
                    <div className='p-3'>
                        <form>
                            <section className='grid grid-cols-[32%_auto] gap-4'>
                                ...
                                <div>
                                    ...
                                    <p className='font-medium text-gray-900 mt-5 text-[14px]'>Title</p>
                                    <input type="text" required placeholder='Title' className='text-[14px] border-1 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2 px-3' />
 ...
 w-[720px] rounded-lg border-slate-300 block'></textarea>
                            ...
                            <button type="submit" className=' mt-8 mb-5 text-white bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-[14px] px-4 py-2'>Add Category</button>
                        </form>
                    </div>
                </div>
