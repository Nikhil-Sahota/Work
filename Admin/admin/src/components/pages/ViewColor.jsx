                ...
                <section className='px-3 py-4' >
                    ...
                    <div className='border-1 rounded border-slate-400'>
                        ...
                        <div className='bg-slate-100 flex justify-between p-3 border-b pb-4 border-slate-400' >
                            <div className='font-semibold text-[#000000 text-[23px]'>View Color</div>
                        ...
                        <div className='bg-gray-50 px-4 py-3 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex gap-9'>
                                <input type="checkbox" />
                                <p className='font-bold text-[#374151] text-[11px] uppercase'>Color Name</p>
                            </div>

                            <div className='flex font-bold text-[#374151] ml-[100px] text-[11px] gap-[70px] uppercase'>
                                <p>	Code</p>
                                <p>Order</p>
                        ...
                        <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
                            ...
                            <div className='flex gap-9 items-center'>
                                <input type="checkbox" />
                                <p className='font-semibold text-[#111827] text-[14px]'>Red</p>
                            </div>

                            <div className='flex font-normal items-center  text-[#6b7280] ml-[100px] text-[14px] gap-[30px]'>
                                <p>#er33rv</p>
