  ...
  return (
    ...
    <>
      ...
      <div className='flex p-3 gap-3 text-[14px] font-medium text-gray-700 border-b-1 border-gray-200'>
        ...
        <p>/</p>
        <p className='cursor-pointer hover:text-blue-600'>Sub Sub Category</p>
        <p>/</p>
      ...
      <section className='px-3 py-4' >
        ...
        <div className='border-1 rounded border-slate-400'>
          ...
          <div className='bg-slate-100 flex justify-between p-3 border-b pb-4 border-slate-400' >
            <div className='font-semibold text-[#000000 text-[23px]'>View Sub Sub Category</div>
          ...
          <div className='bg-gray-50 px-4 py-3 grid grid-cols-[55%_auto]'>
            ...
            <div className='flex gap-9'>
              ...
              <p className='font-bold text-[#374151] text-[11px] uppercase ml-[50px]'>	Sub Category</p>
              <p className='font-bold text-[#374151] text-[11px] uppercase ml-[50px]'>Category Name</p>
            </div>
          ...
          <div className='hover:bg-gray-50 px-4 py-5 grid grid-cols-[55%_auto]'>
            ...
            <div className='flex gap-9 items-center'>
              ...
              <p className='font-semibold text-[#111827] text-[14px] ml-[150px]'>Men</p>
              <p className='font-semibold text-[#111827] text-[14px] ml-[100px]'>Shoe's</p>
            </div>
