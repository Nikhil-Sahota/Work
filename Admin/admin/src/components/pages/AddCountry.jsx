...
export default function AddCountry() {
    return (
        ...
        <>
            ...
            <section className='px-2  py-4 mb-[150px]'>


                <div className='rounded-lg border border-slate-400'>
                    <p className='text-[24px]  py-2 px-3 border-b border-slate-400 font-semibold bg-slate-100'>Add Country</p>
                    <div className='p-3'>
                        <form>
                            ...
                            <input type="number" required min="0" max="20" placeholder='Order' className='text-[14px] border-1 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-2 px-3' />
                            <button type="submit" className=' my-8 text-white bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-[14px] px-4 py-2'>Add Country</button>
                        </form>
                    </div>
                </div>
